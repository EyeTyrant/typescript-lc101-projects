...
console.log("It will take " + spaceShuttle.getDaysToLocation(kilometersToMars) + " for Space Shuttle " + spaceShuttle.name + " to get to Mars.");
console.log("It will take " + spaceShuttle.getDaysToLocation(kilometersToTheMoon) + " for Space Shuttle " + spaceShuttle.name + " to get to the Moon.");
